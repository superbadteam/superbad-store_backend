...
namespace OrderManagement.Infrastructure.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20231227182557_AddUniqueConstraintToShippingAddressesTable")]
    partial class AddUniqueConstraintToShippingAddressesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrderManagement.Core.Domain.UserAggregate.Entities.ShippingAddress", b =>
                {
                    ...
                    b.HasIndex("UserId", "IsMainAddress")
                        .IsUnique()
            ...
            modelBuilder.Entity("OrderManagement.Core.Domain.UserAggregate.Entities.ShippingAddress", b =>
                {
                    ...
                    b.OwnsOne("OrderManagement.Core.Domain.UserAggregate.ValueObjects.PhoneNumber", "PhoneNumber", b1 =>
                        {

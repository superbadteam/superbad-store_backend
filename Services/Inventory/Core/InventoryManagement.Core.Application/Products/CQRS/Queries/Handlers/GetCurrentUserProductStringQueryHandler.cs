...
public class GetCurrentUserProductStringQueryHandler : IQueryHandler<GetCurrentUserProductStringQuery, ProductDetailDto>
{
    private readonly ICurrentUser _currentUser;
    private readonly IReadOnlyRepository<Product> _productReadOnlyRepository;

    public GetCurrentUserProductStringQueryHandler(IReadOnlyRepository<Product> productReadOnlyRepository,
    ...
    public async Task<ProductDetailDto> Handle(GetCurrentUserProductStringQuery request,
        CancellationToken cancellationToken)
    {
        var productIdSpecification = new EntityIdSpecification<Product>(request.ProductId.ToGuid());
        ...
        return Optional<ProductDetailDto>
            ...
            .ThrowIfNotExist(new ProductNotFoundException(request.ProductId.ToGuid())).Get();
    }
}
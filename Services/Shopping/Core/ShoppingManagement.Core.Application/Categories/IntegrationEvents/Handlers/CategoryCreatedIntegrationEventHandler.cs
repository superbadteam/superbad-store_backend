...
using ShoppingManagement.Core.Domain.CategoryAggregate.DomainServices;
using ShoppingManagement.Core.Domain.CategoryAggregate.Entities;

namespace ShoppingManagement.Core.Application.Categories.IntegrationEvents.Handlers;
